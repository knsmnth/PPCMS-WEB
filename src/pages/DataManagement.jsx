...
function ConfirmDialog({ open, onOpenChange, title, description, confirmLabel, requireText, accentColor = '#dc2626', onConfirm, children }) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent style={{ maxWidth: '480px', maxHeight: '90vh', overflowY: 'auto' }}>
        <DialogHeader>
        ...
        {/* Description */}
        <p style={{ fontSize: '0.875rem', color: 'var(--muted-foreground)', lineHeight: 1.65, margin: '0.25rem 0 0 0' }}>
          {description}
        </p>

        {/* Optional extra content (e.g. import preview badge) */}
